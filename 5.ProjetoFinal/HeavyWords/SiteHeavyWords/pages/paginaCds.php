...
// Buscar produtos da categoria cd (ajuste o id da categoria conforme seu banco, ou use WHERE tipo = 'cd' se preferir)
$cds = $conn->query("SELECT id, nome, preco, imagem_url FROM produtos WHERE ativo = 1 AND (tipo = 'cd' OR categoria_id = 3)");
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
