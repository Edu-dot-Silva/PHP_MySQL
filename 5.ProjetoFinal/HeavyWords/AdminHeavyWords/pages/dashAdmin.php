...
<body>
    <a href="listaAdmin.php">Administradores</a>
    <a href="listaLivros.php">Livros</a>
    <a href="listaVinil.php">Vinil</a>
    <a href="listaCd.php">Cd's</a>
    <a href="listaAcessorios.php">Acessorios</a>
    <a href="sair.php" style="margin-left:16px;">Sair</a>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        if ($inativos && $inativos->num_rows > 0):
            ...
            <tr><td colspan="10">Nenhum produto inativo.</td></tr>
        <?php endif; ?>
    </table>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        if ($estoque_baixo && $estoque_baixo->num_rows > 0):
            ...
            <tr><td colspan="10">Nenhum produto com estoque baixo.</td></tr>
        <?php endif; ?>
    </table>
    <h3>Mais vendidos</h3>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        if ($mais_vendidos && $mais_vendidos->num_rows > 0):
            ...
            <tr><td colspan="10">Nenhum produto vendido.</td></tr>
        <?php endif; ?>
    </table>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        if ($pedidos && $pedidos->num_rows > 0):
            ...
            <tr><td colspan="5">Não houve pedidos recentemente.</td></tr>
        <?php endif; ?>
    </table>
</body>
</html>
